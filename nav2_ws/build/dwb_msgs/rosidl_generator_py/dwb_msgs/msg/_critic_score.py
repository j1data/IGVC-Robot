...
class Metaclass_CriticScore(type):
...
class CriticScore(metaclass=Metaclass_CriticScore):
    ...
    def __init__(self, **kwargs):
        ...
        self.raw_score = kwargs.get('raw_score', float())
    ...
    def scale(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'scale' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._scale = value
